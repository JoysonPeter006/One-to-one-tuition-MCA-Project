...
$joinedcourses_qry = "SELECT courses.course_id,schedules.start_time,schedules.end_time,teacher.te_name,teacher.qualification,courselist.course_name
from courses 
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="course_id" id="course_id" class="select2 form-control">
                            <?php while ($courses = mysqli_fetch_array($course_records)) { ?>
                                <option value="<?= $courses['course_id'] ?>"><?= $courses['course_name'] . ' - ' . $courses['te_name'] . ' (' . $courses['qualification'] . ')' ?></option>
                            <?php } ?>
                        </select>
                    </div>
