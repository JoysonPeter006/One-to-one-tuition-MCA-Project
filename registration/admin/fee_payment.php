...
$teacher_qry = "SELECT fullname,email from teacher where te_id  = $teacher_id";
$teacher_result = mysqli_query($db, $teacher_qry);
...
$total_rate = $interval * $schedule['rate'] * 30 * 100 * 0.9;
?>
...
<script
    ...
    data-buttontext="Click to pay salary"
    data-name="WebEdu"
    data-description="Pay salary !!"
    data-prefill.name=">"
    data-prefill.email=""
