...
where courses.student_id =  $student_id and courses.course_status = 2";
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td> <a class="btn btn-sm btn-primary" href="<?= $joinedcourses['class_link'] ?>" target="_blank">Go to classes</a></td>
                                <!-- <td><?= $joinedcourses[''] ?></td> -->
