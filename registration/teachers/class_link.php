...
$joinedcourses_qry = "SELECT courses.course_id,schedules.start_time,schedules.end_time,courses.class_link,courselist.course_name
from courses 
...
where teacher.te_id =  $teacher_id and courses.course_status = 2";
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td> <a class="btn btn-sm btn-primary" href="<?= $joinedcourses['class_link'] ?>" target="_blank">Google meet</a></td>
