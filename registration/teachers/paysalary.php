...
where teacher.te_id =  $teacher_id and courses.course_status = 2 and courses.salary_status = 1";
...
LEFT JOIN teacher on teacher.te_id = courselist.teacher_id
LEFT JOIN schedules on schedules.schedule_id = courses.schedule
where teacher.te_id =  $teacher_id and courses.course_status = 2 and courses.salary_status = 2";
